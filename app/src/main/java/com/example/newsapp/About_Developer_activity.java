...
public class About_Developer_activity extends AppCompatActivity {
    ImageButton linkedin, github;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_about__developer_activity);
        // getActionBar().setDisplayShowHomeEnabled(true);
        getWindow().setStatusBarColor(ContextCompat.getColor(getApplicationContext(), R.color.devloper_ScreenColor));
